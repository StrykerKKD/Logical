...
let _ = Util.print_state_stream "friends" friend_state_stream

let _ = Util.print_state_stream "another friends" another_friend_state_stream
...
let _ = Util.print_state_stream "parent" parent_state_stream
...
let _ = Util.print_state_stream "father" father_state_stream
...
let _ = Util.print_state_stream "mother" mother_state_stream
...
let _ = Util.print_state_stream "friendzoned" friendzoned_state_stream
